...
func TestFromJSON_InvalidSnapshot(t *testing.T) {
	t.Parallel()
	synctest.Test(t, func(t *testing.T) {
		timer, err := timeutil.FromJSON([]byte(`{}`))
		if err == nil {
			t.Fatal("timeutil.FromJSON({}) must return error")
		}

		if timer != nil {
			t.Errorf("timeutil.FromJSON({}) = %v, want nil", timer)
		}
	})
}

func TestTimer_UnmarshalJSON_InvalidSnapshot(t *testing.T) {
	t.Parallel()
	synctest.Test(t, func(t *testing.T) {
		duration := 100 * time.Millisecond
		timer := timeutil.NewTimer(duration)

		err := timer.UnmarshalJSON([]byte(`{}`))
		if err == nil {
			t.Fatal("timer.UnmarshalJSON({}) must return error")
		}
...
func TestRestoreTimer_InvalidSnapshot(t *testing.T) {
	t.Parallel()
	synctest.Test(t, func(t *testing.T) {
		timer, err := timeutil.RestoreTimer(&timeutil.TimerSnapshot{})
		if err == nil {
			t.Fatal("timeutil.RestoreTimer({}) must return error")
		}

		if timer != nil {
			t.Errorf("timeutil.RestoreTimer({}) = %v, want nil", timer)
		}
	})
}

func TestRestoreTimer_NilSnapshot(t *testing.T) {
	t.Parallel()
	synctest.Test(t, func(t *testing.T) {
		timer, err := timeutil.RestoreTimer(nil)
		if err == nil {
			t.Fatal("timeutil.RestoreTimer(nil) must return error")
		}

		if timer != nil {
			t.Errorf("timeutil.RestoreTimer(nil) = %v, want nil", timer)
		}
	})
}
...
func TestFromJSON_Null(t *testing.T) {
	t.Parallel()
	synctest.Test(t, func(t *testing.T) {
		timer, err := timeutil.FromJSON([]byte(`null`))
		if err != nil {
			t.Fatalf("timeutil.FromJSON(null) error = %v, want nil", err)
		}

		if timer != nil {
			t.Errorf("timeutil.FromJSON(null) = %v, want nil", timer)
		}
	})
}

func TestTimer_UnmarshalJSON_Null(t *testing.T) {
	t.Parallel()
	synctest.Test(t, func(t *testing.T) {
		duration := 100 * time.Millisecond
		timer := timeutil.NewTimer(duration)

		err := timer.UnmarshalJSON([]byte(`null`))
		if err == nil {
			t.Fatal("timer.UnmarshalJSON(null) must return error")
		}
