...
description: When preparing to make a git commit
---
...
Write a short English commit message (maximum one sentence) for every change,
formatted in a code block. Use the following format:
